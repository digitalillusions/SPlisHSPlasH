...
void PCISPHModule(py::module m_sub) {
    ...
    py::class_<SPH::SimulationDataPCISPH>(m_sub, "SimulationDataPCISPH")
            ...
            .def("getLastPosition", (Vector3r& (SPH::SimulationDataPCISPH::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPCISPH::getLastPosition)
            ...
            .def("getLastVelocity", (Vector3r& (SPH::SimulationDataPCISPH::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPCISPH::getLastVelocity)
            ...
            .def("getDensityAdv", (Real& (SPH::SimulationDataPCISPH::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPCISPH::getDensityAdv)
            ...
            .def("getPressure", (Real& (SPH::SimulationDataPCISPH::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPCISPH::getPressure)
            ...
            .def("getPressureAccel", (Vector3r& (SPH::SimulationDataPCISPH::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPCISPH::getPressureAccel)
