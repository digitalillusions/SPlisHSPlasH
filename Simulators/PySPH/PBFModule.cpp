...
void PBFModule(py::module m_sub) {
    ...
    py::class_<SPH::SimulationDataPBF>(m_sub, "SimulationDataPBF")
            ...
            .def("getLambda", (Real & (SPH::SimulationDataPBF::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataPBF::getLambda))
            ...
            .def("getDeltaX", (Vector3r & (SPH::SimulationDataPBF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPBF::getDeltaX)
            ...
            .def("getLastPosition", (Vector3r & (SPH::SimulationDataPBF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPBF::getLastPosition)
            ...
            .def("getOldPosition", (Vector3r & (SPH::SimulationDataPBF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPBF::getOldPosition)
