...
void PFModule(py::module m_sub) {
    ...
    py::class_<SPH::SimulationDataPF>(m_sub, "SimulationDataPF")
            ...
            .def("getOldPosition", (Vector3r& (SPH::SimulationDataPF::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataPF::getOldPosition))
            ...
            .def("getNumFluidNeighbors", (unsigned int& (SPH::SimulationDataPF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPF::getNumFluidNeighbors)
            ...
            .def("getS", (Vector3r& (SPH::SimulationDataPF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPF::getS)
            ...
            .def("getDiag", (Vector3r& (SPH::SimulationDataPF::*)(const unsigned int, const unsigned int))&SPH::SimulationDataPF::getDiag)
