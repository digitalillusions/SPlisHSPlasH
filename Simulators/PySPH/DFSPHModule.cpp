...
void DFSPHModule(py::module m_sub) {
    ...
    py::class_<SPH::SimulationDataDFSPH>(m_sub, "SimulationDataDFSPH")
            ...
            .def("getFactor", (Real& (SPH::SimulationDataDFSPH::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataDFSPH::getFactor))
            ...
            .def("getKappa", (Real& (SPH::SimulationDataDFSPH::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataDFSPH::getKappa))
            ...
            .def("getKappaV", (Real& (SPH::SimulationDataDFSPH::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataDFSPH::getKappaV))
            ...
            .def("getDensityAdv", (Real& (SPH::SimulationDataDFSPH::*)(const unsigned int, const unsigned int))(&SPH::SimulationDataDFSPH::getDensityAdv))
